...
- In cases above we often Allowable closed under refinement and Forbidden closed under coarsening.  This lead to ``nice'' things for the (h,L) setting.  

- It is alo natural for a Scheduling problem to be closed the opposite way, Allowable closed under refinement and Forbidden clsoed under coarsening.  In this case though, we find ``niceness'' in a different basis.  
...
- Suppose we have a scheduling problem in the qsym M basis...  
 ...
 **** Never did Co-fundamental at the level of NCQSYM, always moved to QSYM first.  Go back to re-interpret at level of directed coarsening and specialization.  ****
