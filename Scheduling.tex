...
\comment{Notation on allow - sometimes we see (0,1) }
...
The corresponding scheduling problem $S$ does satisfy the conditions of Theorem~\ref{unique}, for every allowable ordered set partition $\Phi$ there is a unique coarsest ordered set partition $\Phi_c$ below $\Phi$ in the directed refinement ordereding.  On the other hand, $S$ can not be written as the conjunction of disjunctions.
...
\comment{I don't actually work at the level of NCQsym in the next section.}
...
\comment{How much of this should I include?  Jump straight to lattice of flats?}
