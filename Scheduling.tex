...
\begin{theorem}
Let $S$ be a scheduling problem such that $\Delta(S)$ is of codimension 1 and the regions are "non-convex polyhedra". Then both $\SSS_S$ and $\xi_S$ satisfy a reciprocity theorem.
\end{theorem}

\begin{theorem}
Let $S$ be a scheduling problem such that $\Delta(S)$ is of codimension 1 and has a convex ear decomposition. Then the coefficients of $\xi_S$ satisfy the "convex ear decomposition constraints".
\end{theorem}
