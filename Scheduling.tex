...
\begin{itemize}
\item Define partitionability and state positivity results in terms of partitionability.
\item Present the special case of partitionability given by directed refinement.
\end{itemize}
