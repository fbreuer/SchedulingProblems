...
\]
The cones $\cone(\Phi)$ are simplicial. If $\Phi$ ranges over all ordered set partitions of $[n]$, these cones form a triangulation of the positive orthand $\RR_{> 0}^n$. In particular,
\[
...
\begin{theorem}
Let $S$ be a scheduling problem on $n$ items. Then $\SSS_S$ is an ncquasisymmetric function of the form
\[
...
\comment{fb: Todo from here...}

\begin{proof}
\comment{This proof is still under construction...} This is just a formal statement of the ideas collected in the preliminary sections above.
